...
public class NovoGeradorDeObservacaoTest {

    private NovoGeradorDeObservacao novoGeradorDeObservacao;

    @BeforeEach
    public void setUp() {
        novoGeradorDeObservacao = new NovoGeradorDeObservacao();
    }
    ...
    public void deveGerarObservacaoSemNota() {
        ...
        String observacao = novoGeradorDeObservacao.geraObservacao(numerosNotaFiscal);
